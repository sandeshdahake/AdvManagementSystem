...
@Component({
    selector: 'jhi-subscription-period',
    templateUrl: './subscription-period.component.html'
})
export class SubscriptionPeriodComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/subscription-period'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: SubscriptionPeriod) {
        return item.id;
    }
