...
@Injectable()
export class SubscriptionPeriodAmsPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.subscriptionPeriodModalRef(component, new SubscriptionPeriodAms());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    subscriptionPeriodModalRef(component: Component, subscriptionPeriod: SubscriptionPeriodAms): NgbModalRef {
