...
@Component({
    selector: 'jhi-city-ams',
    templateUrl: './city-ams.component.html'
})
export class CityAmsComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/city-ams'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: CityAms) {
        return item.id;
    }
