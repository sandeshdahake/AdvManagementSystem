...
describe('Service Tests', () => {
    ...
    describe('SubscriptionPlan Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SubscriptionPlanService);
        ...
        describe('Service methods', () => {
            ...
            it('should return SubscriptionPlan', () => {

                let entity: SubscriptionPlan;
                service.find(123).subscribe((_entity: SubscriptionPlan) => {
                    entity = _entity;
                });
