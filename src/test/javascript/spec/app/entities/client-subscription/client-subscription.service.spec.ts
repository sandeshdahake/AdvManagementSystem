...
describe('Service Tests', () => {
    ...
    describe('ClientSubscription Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ClientSubscriptionService);
        ...
        describe('Service methods', () => {
            ...
            it('should return ClientSubscription', () => {

                let entity: ClientSubscription;
                service.find(123).subscribe((_entity: ClientSubscription) => {
                    entity = _entity;
                });
