...
describe('Service Tests', () => {
    ...
    describe('BannerLocationAms Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(BannerLocationAmsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/banner-locations/' + 123);
            });
            it('should return BannerLocationAms', () => {

                let entity: BannerLocationAms;
                service.find(123).subscribe((_entity: BannerLocationAms) => {
                    entity = _entity;
                });
