...
describe('Service Tests', () => {
    ...
    describe('SubscriptionPlanAms Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SubscriptionPlanAmsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/subscription-plans/' + 123);
            });
            it('should return SubscriptionPlanAms', () => {

                let entity: SubscriptionPlanAms;
                service.find(123).subscribe((_entity: SubscriptionPlanAms) => {
                    entity = _entity;
                });
