...
describe('Service Tests', () => {
    ...
    describe('ClientSubscriptionAms Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ClientSubscriptionAmsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/client-subscriptions/' + 123);
            });
            it('should return ClientSubscriptionAms', () => {

                let entity: ClientSubscriptionAms;
                service.find(123).subscribe((_entity: ClientSubscriptionAms) => {
                    entity = _entity;
                });
