...
describe('Service Tests', () => {
    ...
    describe('SubscriptionPeriod Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SubscriptionPeriodService);
        ...
        describe('Service methods', () => {
            ...
            it('should return SubscriptionPeriod', () => {

                let entity: SubscriptionPeriod;
                service.find(123).subscribe((_entity: SubscriptionPeriod) => {
                    entity = _entity;
                });
