...
describe('Service Tests', () => {
    ...
    describe('SubscriptionPeriodAms Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SubscriptionPeriodAmsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/subscription-periods/' + 123);
            });
            it('should return SubscriptionPeriodAms', () => {

                let entity: SubscriptionPeriodAms;
                service.find(123).subscribe((_entity: SubscriptionPeriodAms) => {
                    entity = _entity;
                });
