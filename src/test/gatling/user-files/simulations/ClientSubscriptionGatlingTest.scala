...
/**
 * Performance test for the ClientSubscription entity.
 */
class ClientSubscriptionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ClientSubscription entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all clientSubscriptions")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created clientSubscription")
                .get("${new_clientSubscription_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created clientSubscription")
            .delete("${new_clientSubscription_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
